...
@class LFPLeftViewController;
@class LFPTabBarController;

@interface LFPAppBaseViewController : UIViewController

@property (nonatomic, strong) LFPLeftViewController     *leftViewController;
